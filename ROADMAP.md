...
> 三省六部的骨架：十二部制 + 公主分拣 + 实时看板 + 完整工作流。

- [x] 十二部制 Agent 架构（公主 + 中书·门下·尚书 + 户礼兵刑工 + 吏部 + 早朝官）
- [x] 公主分拣层 —— 自动识别闲聊/指令，闲聊直接回复，指令提炼标题后转中书省
...
### 🐳 Docker Compose 全功能部署 ✅
- [x] Docker Compose 编排（看板 + 数据同步）
- [ ] CI/CD 自动构建推送镜像
- **难度**：⭐⭐ | **适合第一次贡献**
